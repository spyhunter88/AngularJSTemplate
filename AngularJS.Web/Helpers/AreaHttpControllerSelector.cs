...
namespace AngularJS.Web.Helpers
{
    public class AreaHttpControllerSelector : DefaultHttpControllerSelector
    {
        ...
        /// <summary>
        /// Try to return HttpControllerDescriptor from GetApiController or return base method
        /// </summary>
        ...
        /// <summary>
        /// Take area name from HttpRequestMessage
        /// </summary>
        ...
        /// <summary>
        /// Take all the API Controller types from all of your assemblies,
        /// and store them inside the dictionary with key is FullName and type is type itself.
        /// </summary>
